 ...
 */
class ConfigAdapter {//TODO implement methods

    /**
     * Extracts a yml file from resources to the plugin folder
     * @param name The name of the file in the resources folder
     */
    internal fun setupConfig(name: String) {

    }

    internal fun getConfig(path: Path): HotelsConfiguration? {
        return null
    }

    internal fun saveConfig(config: HotelsConfiguration) {
